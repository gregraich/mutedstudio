...
const projects = [
  {
    title: 'Stone Garden',
    description:
      'A massed stone garden balancing slope and softness, creating a harmonious blend of natural elements and architectural precision.',
  ...
  },
  {
    ...
    description:
      'A sunken conversation pit surrounded by corten steel and structured plantings, designed for intimate gatherings and contemplation.',
  ...
  },
  {
    title: 'Pool House',
    description:
      'A geometric pool house with cantilevered concrete planes, embodying modern architectural principles and functional elegance.',
    status: 'Completed' as const,
    images: [
  ...
  },
  {
    title: 'Courtyard',
    description:
      'A minimalist courtyard with rhythmic stone pavers and sculptural plantings, creating a serene outdoor living space.',
  ...
  },
  {
    ...
    description:
      'A terraced garden with cascading water features and geometric plantings, demonstrating the integration of natural and built elements.',
    status: 'Under Construction' as const,
    images: [
...
const teamMembers = [
  {
    ...
    description:
      "Holds an engineering degree from Queen's University, bringing a strong foundation of structural knowledge and technical precision to every project.",
  ...
  },
  {
    ...
    description:
      'Earned her doctorate in architecture from the University of Toronto, grounding our design ethos in academic excellence and spatial innovation.',
  ...
  },
  {
    ...
    description:
      'Specializing in visual design, 3D rendering, and digital experience, contributing forward-thinking visuals and project previews.',
          ...
          <section className="relative h-screen">
            ...
            <div className="relative h-full flex items-center justify-center text-center">
              <div className="max-w-4xl px-8">
                <h1 className="text-display mb-8 tracking-widest uppercase">Architectural Design-Build</h1>
            ...
            <div className="container mx-auto max-w-6xl">
              <div className="mb-16">
                ...
                <p className="text-body mb-8 max-w-3xl">
                  Muted Studio is an architectural design-build practice based in Toronto. We create bold outdoor
                  environments that balance form and function, using precise design language and premium materials.
                </p>
                <p className="text-body max-w-3xl">
                  Our work explores the relationship between built form and natural elements, creating spaces that are
                  both visually striking and deeply functional.
                </p>
              </div>
